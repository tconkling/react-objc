...
/**
 * Connects the given block to receive emissions from the given signal at the default priority and
...
/**
 * Connects the given block to receive emissions from the given signal at the default priority
